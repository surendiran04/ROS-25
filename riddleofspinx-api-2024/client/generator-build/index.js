...
// ../../node_modules/.pnpm/@prisma+engines-version@5.8.1-1.78caf6feeaed953168c64e15a249c3e9a033ebe2/node_modules/@prisma/engines-version/index.js
...
var require_windows = __commonJS({
  "../../node_modules/.pnpm/isexe@2.0.0/node_modules/isexe/windows.js"(
    ...
    function checkPathExt(path7, options2) {
      var pathext =
        options2.pathExt !== void 0 ? options2.pathExt : process.env.PATHEXT;
      if (!pathext) {
        return true;
      }
...
var require_stdio = __commonJS({
  "../../node_modules/.pnpm/execa@5.1.1/node_modules/execa/lib/stdio.js"(
    ...
    var hasAlias = (options2) =>
      aliases.some((alias) => options2[alias] !== void 0);
...
var require_is_stream = __commonJS({
  "../../node_modules/.pnpm/is-stream@2.0.1/node_modules/is-stream/index.js"(
    ...
    isStream.duplex = (stream2) =>
      isStream.writable(stream2) && isStream.readable(stream2);
...
var require_get_stream = __commonJS({
  "../../node_modules/.pnpm/get-stream@6.0.1/node_modules/get-stream/index.js"(
    ...
    async function getStream(inputStream, options2) {
      ...
      await new Promise((resolve, reject) => {
        const rejectPromise = (error) => {
          if (
            error &&
            stream3.getBufferedLength() <= BufferConstants.MAX_LENGTH
          ) {
    ...
    module2.exports.buffer = (stream3, options2) =>
      getStream(stream3, { ...options2, encoding: "buffer" });
    module2.exports.array = (stream3, options2) =>
      getStream(stream3, { ...options2, array: true });
  ...
  "../../node_modules/.pnpm/execa@5.1.1/node_modules/execa/lib/promise.js"(
    ...
    var mergePromise = (spawned, promise2) => {
      for (const [property2, descriptor] of descriptors) {
        const value =
          typeof promise2 === "function"
            ? (...args) => Reflect.apply(descriptor.value, promise2(), args)
            : descriptor.value.bind(promise2);
...
var require_execa = __commonJS({
  "../../node_modules/.pnpm/execa@5.1.1/node_modules/execa/index.js"(
    ...
    var { handleInput, getSpawnedResult, makeAllStream, validateInputSync } =
      require_stream();
...
var require_locate_path = __commonJS({
  "../../node_modules/.pnpm/locate-path@6.0.0/node_modules/locate-path/index.js"(
    ...
    var matchType = (type, stat) =>
      type === void 0 || stat[typeMappings[type]]();
...
var require_json_parse_even_better_errors = __commonJS({
  "../../node_modules/.pnpm/json-parse-even-better-errors@2.3.1/node_modules/json-parse-even-better-errors/index.js"(
    ...
    var parseJson = (txt, reviver, context) => {
      ...
      context = context || 20;
      try {
        const [, newline = "\n", indent10 = "  "] = parseText.match(emptyRE) ||
...
var require_templates = __commonJS({
  "../../node_modules/.pnpm/chalk@2.4.2/node_modules/chalk/templates.js"(
    ...
    module2.exports = (chalk, tmp) => {
      ...
      tmp.replace(
        TEMPLATE_REGEX,
        (m, escapeChar, inverse2, style, close, chr) => {
          if (escapeChar) {
    ...
    var licensesWithOneVersion = Object.keys(licensesWithVersions)
      ...
      .filter(function identifySoleVersions(item) {
        return (
          ...
          item[1].length === 1 &&
          item[0] !== null && // APL will be considered Apache, rather than APL-1.0
          item[0] !== "APL"
        );
      })
  ...
  "../../node_modules/.pnpm/path-parse@1.0.7/node_modules/path-parse/index.js"(
    ...
    win32.parse = function (pathString) {
      ...
      return {
        root: allParts[1],
        dir:
          allParts[0] === allParts[1] ? allParts[0] : allParts[0].slice(0, -1),
        base: allParts[2],
        ext: allParts[4],
        name: allParts[3],
      };
    ...
    if (isWindows) module2.exports = win32.parse;
    else module2.exports = posix.parse;
...
var require_async = __commonJS({
  "../../node_modules/.pnpm/resolve@1.22.8/node_modules/resolve/lib/async.js"(
    ...
    var realpathFS =
      process.platform !== "win32" &&
      fs6.realpath &&
      typeof fs6.realpath.native === "function"
        ? fs6.realpath.native
        : fs6.realpath;
      ...
      function loadAsFile(x2, thePackage, callback2) {
        ...
        function load(exts2, x3, loadPackage) {
          ...
          function onex(err2, ex) {
            if (err2) return cb2(err2);
            if (ex) return cb2(null, file, pkg2);
          ...
          isFile(pkgfile, function (err2, ex) {
            ...
            readPackage(readFile2, pkgfile, function (err3, pkgParam) {
              ...
              if (pkg2 && pkg2.main) {
                ...
                loadAsFile(
                  path7.resolve(x2, pkg2.main),
                  pkg2,
                  function (err4, m, pkg3) {
                    if (err4) return cb2(err4);
                    if (m) return cb2(null, m, pkg3);
                    if (!pkg3)
...
var require_sync = __commonJS({
  "../../node_modules/.pnpm/resolve@1.22.8/node_modules/resolve/lib/sync.js"(
    ...
    var realpathFS =
      process.platform !== "win32" &&
      fs6.realpathSync &&
      typeof fs6.realpathSync.native === "function"
        ? fs6.realpathSync.native
        : fs6.realpathSync;
    var homedir = getHomedir();
    var defaultPaths = function () {
      return [
      ...
      function loadAsDirectorySync(x2) {
        ...
        if (isFile(pkgfile)) {
          ...
          if (pkg2 && pkg2.main) {
            if (typeof pkg2.main !== "string") {
              var mainError = new TypeError(
                "package \u201C" + pkg2.name + "\u201D `main` must be a string"
              );
              mainError.code = "INVALID_PACKAGE_MAIN";
              throw mainError;
            }
  ...
  "../../node_modules/.pnpm/normalize-package-data@2.5.0/node_modules/normalize-package-data/lib/fixer.js"(
    ...
    var fixer = (module2.exports = {
      ...
      fixNameField: function (data, options2) {
        if (typeof options2 === "boolean") options2 = { strict: options2 };
        else if (typeof options2 === "undefined") options2 = {};
...
var require_main2 = __commonJS({
  "../../node_modules/.pnpm/dotenv@16.0.3/node_modules/dotenv/lib/main.js"(
    ...
    function _resolveHome(envPath) {
      return envPath[0] === "~"
        ? path7.join(os.homedir(), envPath.slice(1))
        : envPath;
    }
    function config(options2) {
      ...
      try {
        const parsed = DotenvModule.parse(
          fs6.readFileSync(dotenvPath, { encoding })
        );
    ...
    function patch(fs6) {
      ...
      function statFix(orig) {
        ...
        return function (target, options2, cb) {
          ...
          return options2
            ? orig.call(fs6, target, options2, callback)
...
var require_graceful_fs = __commonJS({
  "../../node_modules/.pnpm/graceful-fs@4.2.10/node_modules/graceful-fs/graceful-fs.js"(
    ...
    var debug7 = noop;
    if (util2.debuglog) debug7 = util2.debuglog("gfs4");
      ...
      function readdir(path7, options2, cb) {
        ...
        var go$readdir = noReaddirOptionVersions.test(process.version)
          ? function go$readdir2(path8, options3, cb2, startTime) {
              return fs$readdir(
                path8,
                fs$readdirCallback(path8, options3, cb2, startTime)
              );
            }
          : function go$readdir2(path8, options3, cb2, startTime) {
              return fs$readdir(
    ...
    module2.exports.checkPath = function checkPath(pth) {
      if (process.platform === "win32") {
        const pathHasInvalidWinCharacters = /[<>:"|?*]/.test(
          pth.replace(path7.parse(pth).root, "")
        );
  ...
  "../../node_modules/.pnpm/fs-extra@11.1.1/node_modules/fs-extra/lib/util/stat.js"(
    ...
    function checkParentPaths(src, srcStat, dest, funcName, cb) {
      ...
      if (
        ...
        destParent === path7.parse(destParent).root
      )
        return cb();
...
var require_empty = __commonJS({
  "../../node_modules/.pnpm/fs-extra@11.1.1/node_modules/fs-extra/lib/empty/index.js"(
    ...
    var emptyDir = u(async function emptyDir2(dir) {
      ...
      return Promise.all(
        items.map((item) => remove.remove(path7.join(dir, item)))
      );
    });
...
var require_symlink = __commonJS({
  "../../node_modules/.pnpm/fs-extra@11.1.1/node_modules/fs-extra/lib/ensure/symlink.js"(
    ...
    function createSymlink(srcpath, dstpath, type, callback) {
      ...
      fs6.lstat(dstpath, (err, stats) => {
        if (!err && stats.isSymbolicLink()) {
          Promise.all([fs6.stat(srcpath), fs6.stat(dstpath)]).then(
            ([srcStat, dstStat]) => {
    ...
    function createSymlinkSync(srcpath, dstpath, type) {
      ...
      if (exists3) return fs6.symlinkSync(srcpath, dstpath, type);
      mkdirsSync(dir);
...
var require_semver2 = __commonJS({
  "../../node_modules/.pnpm/semver@6.3.1/node_modules/semver/semver.js"(
    ...
    safeRe[t.COMPARATORTRIM] = new RegExp(
      makeSafeRe(src[t.COMPARATORTRIM]),
      "g"
    );
    var comparatorTrimReplace = "$1$2$3";
    tok("HYPHENRANGE");
    ...
    function SemVer(version, options2) {
      ...
      var m = version
        .trim()
        .match(options2.loose ? safeRe[t.LOOSE] : safeRe[t.FULL]);
      if (!m) {
        throw new TypeError("Invalid Version: " + version);
      }
      this.raw = version;
...
var require_make_dir2 = __commonJS({
  "../../node_modules/.pnpm/make-dir@3.1.0/node_modules/make-dir/index.js"(
    ...
    var useNativeRecursiveOption = semver.satisfies(
      process.version,
      ">=10.12.0"
    );
    var checkPath = (pth) => {
  ...
  "../../node_modules/.pnpm/find-cache-dir@3.3.2/node_modules/find-cache-dir/index.js"(
    ...
    function getNodeModuleDirectory(directory) {
      ...
      if (
        ...
        (fs6.existsSync(nodeModules) || !isWritable(path7.join(directory)))
      ) {
        return;
      }
      return nodeModules;
    ...
    module2.exports = (options2 = {}) => {
      ...
      return useDirectory(
        path7.join(directory, "node_modules", ".cache", options2.name),
        options2
      );
    };
  },
  ...
  "../../node_modules/.pnpm/pluralize@8.0.0/node_modules/pluralize/pluralize.js"(
    ...
    (function (root, pluralize3) {
      ...
      function pluralize3(word, count, inclusive) {
        var pluralized =
          count === 1 ? pluralize3.singular(word) : pluralize3.plural(word);
...
var require_env_paths = __commonJS({
  "../../node_modules/.pnpm/env-paths@2.2.1/node_modules/env-paths/index.js"(
    ...
    var windows = (name) => {
      ...
      const localAppData =
        env.LOCALAPPDATA || path7.join(homedir, "AppData", "Local");
      return {
    ...
    var linux = (name) => {
      const kid = path7.basename(homedir);
      return {
        data: path7.join(
          env.XDG_DATA_HOME || path7.join(homedir, ".local", "share"),
          name
        ),
        config: path7.join(
          env.XDG_CONFIG_HOME || path7.join(homedir, ".config"),
          name
        ),
        cache: path7.join(
          env.XDG_CACHE_HOME || path7.join(homedir, ".cache"),
          name
        ),
        // https://wiki.debian.org/XDGBaseDirectorySpecification#state
        log: path7.join(
          env.XDG_STATE_HOME || path7.join(homedir, ".local", "state"),
          name
        ),
        temp: path7.join(tmpdir, kid, name),
      };
    };
...
var require_locate_path3 = __commonJS({
  "../../node_modules/.pnpm/locate-path@3.0.0/node_modules/locate-path/index.js"(
    ...
    module2.exports = (iterable, options2) => {
      ...
      return pLocate(
        iterable,
        (el) => pathExists(path7.resolve(options2.cwd, el)),
        options2
      );
    };
  ...
  "package.json"(exports2, module2) {
    module2.exports = {
      ...
      scripts: {
        ...
        "test:e2e":
          "dotenv -e ../../.db.env -- node -r esbuild-register tests/e2e/_utils/run.ts",
        "test:functional":
          "dotenv -e ../../.db.env -- node -r esbuild-register helpers/functional-test/run-tests.ts",
        "test:memory":
          "dotenv -e ../../.db.env -- node -r esbuild-register helpers/memory-tests.ts",
        "test:functional:code":
          "dotenv -e ../../.db.env -- node -r esbuild-register helpers/functional-test/run-tests.ts --no-types",
        "test:functional:types":
          "dotenv -e ../../.db.env -- node -r esbuild-register helpers/functional-test/run-tests.ts --types-only",
        "test-notypes":
        ...
        "new-test":
          "NODE_OPTIONS='-r esbuild-register' yo ./helpers/generator-test/index.ts",
      },
      files: [
        "README.md",
        "runtime",
      ...
      while (sourceIndex < sourceLen) {
        ...
        if (exists3 === true) {
          ...
          if (element) {
            ...
            var spreadable =
              Object.getOwnPropertySymbols(element).includes(
...
var init_TypeBuilder = __esm({
  "src/generation/ts-builders/TypeBuilder.ts"() {
    ...
    TypeBuilder = class {
      ...
      subKey(key) {
        const { KeyType: KeyType2 } =
          (init_KeyType(), __toCommonJS(KeyType_exports));
...
function getNodeAPIName(binaryTarget, type) {
  ...
  if (binaryTarget.includes("windows")) {
    return isUrl
      ...
      : `query_engine-${binaryTarget}.dll.node`;
...
function getSchemaPathFromPackageJsonSync(cwd) {
  ...
  const absoluteSchemaPath = import_path.default.isAbsolute(
    schemaPathFromPkgJson
  )
    ? schemaPathFromPkgJson
    : import_path.default.resolve(
        import_path.default.dirname(pkgJson.path),
        schemaPathFromPkgJson
      );
  if (import_fs.default.existsSync(absoluteSchemaPath) === false) {
    throw new Error(
      `Provided schema path \`${import_path.default.relative(
        cwd,
        absoluteSchemaPath
      )}\` from \`${import_path.default.relative(
        cwd,
        pkgJson.path
      )}\` doesn't exist.`
    );
...
function getProjectRootEnvPath(opts) {
    ...
    if (import_find_up.default.sync.exists(pkgPath)) {
      try {
        const pkg2 = JSON.parse(
          import_fs3.default.readFileSync(pkgPath, "utf8")
        );
  ...
  const candidate = import_path2.default.join(
    import_path2.default.dirname(pkgJsonPath),
    ".env"
  );
...
function schemaPathToEnvPath(schemaPath2) {
  ...
  return import_path2.default.join(
    import_path2.default.dirname(schemaPath2),
    ".env"
  );
}
...
function pathToPosix(filePath) {
  ...
  return filePath
    .split(import_path3.default.sep)
    .join(import_path3.default.posix.sep);
}
...
function docComment(firstParameter) {
  if (
    ...
    typeof firstParameter === "undefined"
  ) {
...
function omit(type, keyType2) {
  return namedType("Omit")
    .addGenericArgument(type)
    .addGenericArgument(keyType2);
}
...
var Writer = class {
  ...
  indentedCurrentLine() {
    const line = this.currentLine.padStart(
      this.currentLine.length + INDENT_SIZE * this.currentIndent
    );
...
function getReturnType({
  ...
  if (isList || hideCondition) {
    ...
    return `${promiseOpen}$Result.GetResult<${getPayloadName(
      name
    )}<ExtArgs>, T, '${actionName}'>${
      isChaining ? " | Null" : ""
    }${promiseClose}`;
  }
  ...
  if (
    ...
    actionName === DMMF.ModelAction.findUnique
  ) {
    return `Prisma__${name}Client<${getType(
      `$Result.GetResult<${getPayloadName(name)}<ExtArgs>, T, '${actionName}'>`,
      isList
...
var extArgsParam = genericParameter("ExtArgs")
  .extends(namedType("$Extensions.InternalArgs"))
  .default(namedType("$Extensions.DefaultArgs"));
...
var JSDocFields = {
  take: (singular, plural) =>
    addLinkToDocs(
      `Take \`\xB1n\` ${plural} from the position of the cursor.`,
      "pagination"
    ),
...
const ${lowerCase(ctx.mapping.model)} = await ${ctx.method}({
  ...
  findUniqueOrThrow: {
    body: (ctx) => `Find one ${
      ctx.singular
    } that matches the filter or throw an error  with \`error.code='P2025'\` 
...
`,
  ...
  aggregate: {
    body: (ctx) => `Allows you to perform aggregations operations on a ${
      ctx.singular
    }.
${undefinedNote}
@param {${getModelArgName(
...
@param {${getModelArgName(
      ctx.model.name,
      ctx.action
    )}} args - Select which aggregations you would like to apply.
@example
const ${lowerCase(ctx.mapping.model)} = await ${ctx.method}({
  pipeline: [
...
@param {${getModelArgName(
      ctx.model.name,
      ctx.action
    )}} args - Select which filters you would like to apply.
@example
const ${lowerCase(ctx.mapping.model)} = await ${ctx.method}({
  filter: { age: { $gt: 25 } } 
})`,
...
var InputField = class {
  ...
  toTS() {
    const property2 = buildInputField(
      this.field,
      this.genericsInfo,
      this.source
    );
...
function xorTypes(types) {
  return types.reduce((prev, curr) =>
    namedType("XOR").addGenericArgument(prev).addGenericArgument(curr)
  );
}
var InputType = class {
  ...
  toTS() {
    ...
    if (!action && !this.generatedName) {
      this.context.defaultArgsAliases.addPossibleAlias(
        getModelArgName(name),
        getLegacyModelArgName(name)
      );
    }
...
${(0, import_indent_string2.default)(
  argsToGenerate
    .map((arg) => new InputField(arg, this.context.genericArgsInfo).toTS())
    .join("\n"),
  TAB_SIZE
)}
}
`;
  ...
  getGeneratedComment() {
    return (
      this.comment ?? `${this.type.name} ${this.action ?? "without action"}`
    );
  }
};
...
${(0, import_indent_string3.default)(
  ...
  TAB_SIZE
    ...
    const enumBody = this.isStrictEnum()
      ? `makeStrictEnum(${enumVariants})`
      : enumVariants;
...
${(0, import_indent_string3.default)(
  type.values.map((v) => `${v}: ${this.getValueTS(v)}`).join(",\n"),
  TAB_SIZE
)}
};
...
function buildOutputType(type) {
  return moduleExport(
    typeDeclaration(
      type.name,
      objectType().addMultiple(type.fields.map(buildOutputField))
    )
  );
}
...
function buildModelPayload(model, dmmf2) {
  ...
  const scalarsType = isComposite
    ...
    : namedType("$Extensions.GetPayloadResult")
        ...
        .addGenericArgument(
          namedType("ExtArgs").subKey("result").subKey(lowerCase(model.name))
        );
  const payloadTypeDeclaration = typeDeclaration(
    getPayloadName(model.name, false),
    objectType()
      .add(property("name", stringLiteral(model.name)))
      .add(property("objects", objects))
      .add(property("scalars", scalarsType))
      .add(property("composites", composites))
  );
  if (!isComposite) {
...
var extArgsParameter = genericParameter("ExtArgs")
  .extends(namedType("$Extensions.InternalArgs"))
  .default(namedType("$Extensions.DefaultArgs"));
function buildIncludeType({ modelName, dmmf: dmmf2, fields }) {
  const type = buildSelectOrIncludeObject(
    modelName,
    getIncludeFields(fields, dmmf2)
  );
...
function buildSelectType({ modelName, fields }) {
  ...
  const selectType = namedType("$Extensions.GetSelect")
    .addGenericArgument(objectType2)
    .addGenericArgument(
      extArgsParameter
        .toArgument()
        .subKey("result")
        .subKey(lowerCase(modelName))
    );
...
function buildScalarSelectType({ modelName, fields }) {
  ...
  return moduleExport(
    typeDeclaration(`${getSelectName(modelName)}Scalar`, object)
  );
}
...
function getModelActions(dmmf2, name) {
  const mapping = dmmf2.mappingsMap[name] ?? {
    model: name,
    plural: `${name}s`,
  };
...
var Model = class {
  ...
  get argsTypes() {
    ...
    for (const action of Object.keys(DMMF.ModelAction)) {
      ...
      if (
        ...
        argsTypes.push(
          new MinimalArgsType(field.args, this.type, this.context, action)
        );
        ...
        argsTypes.push(
          new ArgsType(field.args, this.type, this.context, action)
        );
      }
    }
  ...
  getGroupByTypes() {
    ...
    const groupByType =
      this.dmmf.outputTypeMap.prisma[getGroupByName(model.name)];
    if (!groupByType) {
      ...
      groupByType.fields
        ...
        .map((f) => {
          if (f.outputType.location === "outputObjectTypes") {
            return `${f.name}?: ${getAggregateInputType(f.outputType.type)}${
              f.name === "_count" ? " | true" : ""
            }`;
          }
          return "";
...
type ${getGroupByPayloadName(
      model.name
    )}<T extends ${groupByArgsName}> = Prisma.PrismaPromise<
  Array<
...
`;
  ...
  getAggregationTypes() {
    const { model, mapping } = this;
    let aggregateType =
      this.dmmf.outputTypeMap.prisma[getAggregateName(model.name)];
    if (!aggregateType) {
      throw new Error(
    ...
    const avgType =
      this.dmmf.outputTypeMap.prisma[getAvgAggregateName(model.name)];
    const sumType =
      this.dmmf.outputTypeMap.prisma[getSumAggregateName(model.name)];
    const minType =
      this.dmmf.outputTypeMap.prisma[getMinAggregateName(model.name)];
    const maxType =
      this.dmmf.outputTypeMap.prisma[getMaxAggregateName(model.name)];
    const countType =
      this.dmmf.outputTypeMap.prisma[getCountAggregateOutputName(model.name)];
    if (avgType) {
    ...
    .concat(
      aggregateType.fields.map((f) => {
        ...
        if (f.name === "_count" || f.name === "count") {
          data += `${f.name}?: true | ${getCountAggregateInputName(
            model.name
          )}`;
        } else {
...
`;
    ...
    const modelTypeExport = moduleExport(
      typeDeclaration(
        model.name,
        namedType(`$Result.DefaultSelection`).addGenericArgument(
          namedType(getPayloadName(model.name))
        )
      )
...
${stringify(
  buildSelectType({ modelName: this.model.name, fields: this.type.fields })
)}
${stringify(
  buildScalarSelectType({
    modelName: this.model.name,
    fields: this.type.fields,
  }),
  {
...
type ${
      model.name
    }GetPayload<S extends boolean | null | undefined | ${getModelArgName(
      model.name
...
var ModelDelegate = class {
  ...
  getNonAggregateActions(availableActions) {
    const actions = availableActions.filter(
      (key) =>
        key !== DMMF.ModelAction.aggregate &&
        key !== DMMF.ModelAction.groupBy &&
        key !== DMMF.ModelAction.count
    );
    return actions;
  }
  toTS() {
    ...
    const excludedArgsForCountType = excludedArgsForCount
      .map((name2) => `'${name2}'`)
      .join(" | ");
    return `${
...
${
  availableActions.includes(DMMF.ModelAction.aggregate)
    ? `${(0, import_indent_string4.default)(
        getMethodJSDoc(DMMF.ModelAction.count, mapping, modelOrType),
        TAB_SIZE
      )}
...
${
  availableActions.includes(DMMF.ModelAction.aggregate)
    ? `${(0, import_indent_string4.default)(
        getMethodJSDoc(DMMF.ModelAction.aggregate, mapping, modelOrType),
        TAB_SIZE
      )}
...
${
  availableActions.includes(DMMF.ModelAction.groupBy)
    ? `${(0, import_indent_string4.default)(
        getMethodJSDoc(DMMF.ModelAction.groupBy, mapping, modelOrType),
        TAB_SIZE
      )}
  groupBy<
  ...
  fields
    .filter((f) => {
      return (
        ...
        !dmmf2.isComposite(f.outputType.type) &&
        f.name !== "_count"
      );
    })
    .map((f) => {
...
var DMMFHelper = class {
  ...
  hasEnumInNamespace(enumName, namespace) {
    return (
      this.schema.enumTypes[namespace]?.find(
        (schemaEnum) => schemaEnum.name === enumName
      ) !== void 0
    );
  }
  resolveInputObjectType(ref) {
    return this.inputTypesByName.get(
      fullyQualifiedName(ref.type, ref.namespace)
    );
  }
  resolveOutputObjectType(ref) {
    ...
    return this.outputObjectTypes[ref.namespace ?? "prisma"].find(
      (outputObject) => outputObject.name === ref.type
    );
  }
  buildModelMap() {
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    ...
    ${JSON.stringify(
      pathToPosix(relativeOutdir).split("/").slice(1).join("/")
    )},
  ]
...
// src/generation/utils/buildNFTAnnotations.ts
function buildNFTAnnotations(
  noEngine2,
  engineType,
  binaryTargets,
  relativeOutdir
) {
  if (noEngine2 === true) return "";
  if (binaryTargets === void 0) {
    return "";
  }
  if (process.env.NETLIFY) {
    const isNodeMajor20OrUp =
    ...
    const isRuntimeEnvVar18OrDown =
      awsRuntimeVersion && awsRuntimeVersion <= 18;
    if (
  ...
  const engineAnnotations = map(binaryTargets, (binaryTarget) => {
    ...
    return engineFilename
      ? buildNFTAnnotation(engineFilename, relativeOutdir)
      : "";
  }).join("\n");
...
* Extensions
*/
Prisma.getExtensionContext = ${notSupportOnBrowser(
  "Extensions.getExtensionContext",
  browser
)}
Prisma.defineExtension = ${notSupportOnBrowser(
      ...
      aliases.push(
        stringify(
          moduleExport(
            typeDeclaration(
              legacyName,
              namedType(newName).addGenericArgument(extArgsParam.toArgument())
...
function clientTypeMapModelsResultDefinition(modelName, action) {
  if (action === "count")
    return `$Utils.Optional<${getCountAggregateOutputName(
      modelName
    )}> | number`;
  if (action === "groupBy")
...
function clientTypeMapOthersDefinition() {
  const otherOperationsNames = this.dmmf
    .getOtherOperationNames()
    .flatMap((n) => {
...
function clientTypeMapDefinition() {
  const typeMap = `${clientTypeMapModelsDefinition.bind(
    this
  )()} & ${clientTypeMapOthersDefinition.bind(this)()}`;
  return `
...
function batchingTransactionDefinition() {
  const method2 = method("$transaction")
    .setDocComment(
      docComment`
    ...
    .addGenericParameter(
      genericParameter("P").extends(array(prismaPromise(anyType)))
    )
    .addParameter(parameter("arg", arraySpread(namedType("P"))))
    .setReturnType(
      promise(
        namedType("runtime.Types.Utils.UnwrapTuple").addGenericArgument(
          namedType("P")
        )
      )
    );
  if (this.dmmf.hasEnumInNamespace("TransactionIsolationLevel", "prisma")) {
    const options2 = objectType()
      .formatInline()
      .add(
        property(
          "isolationLevel",
          namedType("Prisma.TransactionIsolationLevel")
        ).optional()
      );
...
function interactiveTransactionDefinition() {
  const options2 = objectType()
    .formatInline()
    .add(property("maxWait", numberType).optional())
    .add(property("timeout", numberType).optional());
  if (this.dmmf.hasEnumInNamespace("TransactionIsolationLevel", "prisma")) {
    const isolationLevel = property(
      "isolationLevel",
      namedType("Prisma.TransactionIsolationLevel")
    ).optional();
  ...
  const callbackType = functionType()
    .addParameter(
      parameter(
        "prisma",
        omit(namedType("PrismaClient"), namedType("runtime.ITXClientDenyList"))
      )
    )
    .setReturnType(returnType);
  const method2 = method("$transaction")
    .addGenericParameter(genericParameter("R"))
    .addParameter(parameter("fn", callbackType))
    .addParameter(parameter("options", options2).optional())
    .setReturnType(returnType);
  return stringify(method2, { indentLevel: 1, newLine: "leading" });
}
...
function metricDefinition() {
  ...
  const property2 = property(
    "$metrics",
    namedType(`runtime.${runtimeImport("MetricsClient")}`)
  )
    .setDocComment(
      docComment`
...
function runCommandRawDefinition() {
  ...
  const method2 = method("$runCommandRaw")
    .addParameter(parameter("command", namedType("Prisma.InputJsonObject")))
    .setReturnType(prismaPromise(namedType("Prisma.JsonObject")))
...
${[
  ...
  .trim()}
    ...
    ${(0, import_indent_string8.default)(
      dmmf2.mappings.modelOperations
        .filter((m) => m.findMany)
        .map((m) => {
...
`;
  ...
  buildClientOptions() {
    const clientOptions = interfaceDeclaration("PrismaClientOptions")
      .add(
        property("datasources", namedType("Datasources"))
          .optional()
          .setDocComment(
            docComment(
      ...
      .add(
        property("datasourceUrl", stringType)
          .optional()
          .setDocComment(
            docComment(
              "Overwrites the datasource url from your schema.prisma file"
      ...
      .add(
        property("errorFormat", namedType("ErrorFormat"))
          .optional()
          .setDocComment(docComment('@default "colorless"'))
      )
      .add(
        property(
          "log",
          array(unionType([namedType("LogLevel"), namedType("LogDefinition")]))
        ).optional().setDocComment(docComment`
             @example
             \`\`\`
             // Defaults to stdout
    ...
    if (
      this.runtimeName === "library" &&
      this.generator?.previewFeatures.includes("driverAdapters")
    ) {
      clientOptions.add(
        property(
          "adapter",
          unionType([namedType("runtime.DriverAdapter"), namedType("null")])
        )
          .optional()
          .setDocComment(
            docComment(
...
var TSClient = class _TSClient {
  constructor(options2) {
    ...
    _TSClient.enabledPreviewFeatures =
      this.options.generator?.previewFeatures ?? [];
  }
  async toJS(edge = false) {
    ...
    const relativeEnvPaths = {
      rootEnvPath:
        ...
        pathToPosix(
          import_path6.default.relative(outputDir2, envPaths.rootEnvPath)
        ),
      schemaEnvPath:
        envPaths.schemaEnvPath &&
        pathToPosix(
          import_path6.default.relative(outputDir2, envPaths.schemaEnvPath)
        ),
    };
    ...
    const inlineSchema = (
      await (0, import_promises.readFile)(schemaPath2)
    ).toString("base64");
    const inlineSchemaHash = import_crypto.default
      .createHash("sha256")
      .update(inlineSchema)
      .digest("hex");
    const config = {
      ...
      relativePath: pathToPosix(
        import_path6.default.relative(
          outputDir2,
          import_path6.default.dirname(schemaPath2)
        )
      ),
    ...
    const relativeOutdir = import_path6.default.relative(
      process.cwd(),
      outputDir2
    );
...
`;
  ...
  toTS(edge = false) {
    ...
    const modelAndTypes = Object.values(this.dmmf.typeAndModelMap).reduce(
      (acc, modelOrType) => {
    ...
    for (const enumType of this.dmmf.schema.enumTypes.model ?? []) {
      ...
      modelEnumsAliases.push(
        stringify(
          moduleExport(
            typeDeclaration(enumType.name, namedType(`$Enums.${enumType.name}`))
          )
        ),
        stringify(
          moduleExport(
            constDeclaration(
              enumType.name,
              namedType(`typeof $Enums.${enumType.name}`)
            )
          )
        )
      );
    ...
    const fieldRefs =
      this.dmmf.schema.fieldRefTypes.prisma?.map((type) =>
        new FieldRefInput(type).toTS()
      ) ?? [];
    const countTypes = this.dmmf.schema.outputObjectTypes.prisma
...
${this.dmmf.inputObjectTypes.prisma
  .reduce((acc, inputType) => {
    if (inputType.name.includes("Json") && inputType.name.includes("Filter")) {
      const needsGeneric =
        this.genericsInfo.typeNeedsGenericModelArg(inputType);
      const innerName = needsGeneric
        ? `${inputType.name}Base<$PrismaModel>`
        : `${inputType.name}Base`;
      const typeName = needsGeneric
        ? `${inputType.name}<$PrismaModel = never>`
        : inputType.name;
  ...
  | OptionalFlat<Omit<${baseName}, 'path'>>`);
      acc.push(
        new InputType(inputType, this.genericsInfo)
          .overrideName(`${inputType.name}Base`)
          .toTS()
      );
    } else {
...
${
  this.dmmf.inputObjectTypes.model
    ?.map((inputType) => new InputType(inputType, this.genericsInfo).toTS())
    .join("\n") ?? ""
}
...
async function buildClient({
  ...
  const clientEngineType2 =
    overrideEngineType2 ?? getClientEngineType(generator2);
  const tsClientOptions = {
    ...
    binaryTargets:
      clientEngineType2 === "library" /* Library */
        ? Object.keys(binaryPaths2.libqueryEngine ?? {})
        : Object.keys(binaryPaths2.queryEngine ?? {}),
    schemaPath: schemaPath2,
    outputDir: outputDir2,
    clientVersion: clientVersion3,
    engineVersion: engineVersion2,
...
async function getDefaultOutdir(outputDir2) {
  ...
  if (
    ...
    if (
      (0, import_fs5.existsSync)(
        import_path7.default.join(process.env.INIT_CWD, "package.json")
      )
    ) {
    ...
    const packagePath = await (0, import_pkg_up.default)({
      cwd: process.env.INIT_CWD,
    });
    if (packagePath) {
      return import_path7.default.join(
        import_path7.default.dirname(packagePath),
        "node_modules/.prisma/client"
      );
    }
  }
...
async function generateClient(options) {
  ...
  const { runtimeDirs, finalOutputDir, projectRoot } = await getGenerationDirs(
    options
  );
...
To learn more about how to rename models, check out https://pris.ly/d/naming-models`;
  ...
  await (0, import_fs_extra.ensureDir)(
    import_path7.default.join(outputDir, "runtime")
  );
  if (generator?.previewFeatures.includes("deno") && !!globalThis.Deno) {
    await (0, import_fs_extra.ensureDir)(
      import_path7.default.join(outputDir, "deno")
    );
  }
  await Promise.all(
  ...
  if (
    copyRuntime ||
    !import_path7.default
      .resolve(outputDir)
      .endsWith(`@prisma${import_path7.default.sep}client`)
  ) {
  ...
  const enginePath =
    clientEngineType === "library" /* Library */
  ...
  if (
    transpile === true &&
    noEngine !== true &&
    getClientEngineType(generator) !== "wasm" /* Wasm */
  ) {
    if (process.env.NETLIFY) {
    ...
    for (const [binaryTarget, filePath] of Object.entries(enginePath)) {
      ...
      if (
        process.env.NETLIFY &&
        !["rhel-openssl-1.0.x", "rhel-openssl-3.0.x"].includes(binaryTarget)
      ) {
  ...
  const schemaTargetPath = import_path7.default.join(
    finalOutputDir,
    "schema.prisma"
  );
  ...
  if (getClientEngineType(generator) === "wasm" /* Wasm */) {
    const queryEngineWasmFilePath = import_path7.default.join(
      runtimeSourceDir,
      "query-engine.wasm"
    );
    const queryEngineWasmTargetPath = import_path7.default.join(
      finalOutputDir,
      "query-engine.wasm"
    );
    const dummyQueryEngineBgTargetPath = import_path7.default.join(
      finalOutputDir,
      "query_engine_bg.js"
    );
    const dummyQueryEngineBgContents =
      "/** Dummy file needed by some bundlers when using `query-engine.wasm` */";
    const copyOrSymlink = testMode
      ? import_promises2.default.symlink
      : import_promises2.default.copyFile;
    await copyOrSymlink(queryEngineWasmFilePath, queryEngineWasmTargetPath);
    await import_promises2.default.writeFile(
      dummyQueryEngineBgTargetPath,
      dummyQueryEngineBgContents
    );
  }
  const proxyIndexJsPath = import_path7.default.join(outputDir, "index.js");
  const proxyIndexBrowserJsPath = import_path7.default.join(
    outputDir,
    "index-browser.js"
  );
  ...
  if (!(0, import_fs5.existsSync)(proxyIndexJsPath)) {
    await import_promises2.default.copyFile(
      import_path7.default.join(__dirname, "../../index.js"),
      proxyIndexJsPath
    );
  }
  if (!(0, import_fs5.existsSync)(proxyIndexDTSPath)) {
    await import_promises2.default.copyFile(
      import_path7.default.join(__dirname, "../../index.d.ts"),
      proxyIndexDTSPath
    );
  }
  if (!(0, import_fs5.existsSync)(proxyIndexBrowserJsPath)) {
    await import_promises2.default.copyFile(
      import_path7.default.join(__dirname, "../../index-browser.js"),
...
async function getGenerationDirs({
  ...
  const useDefaultOutdir = testMode2
    ? !runtimeDirs2
    : !generator2?.isCustomOutput;
  const _runtimeDirs = {
    // if we have an override, we use it, but if not then use the defaults
    node:
      runtimeDirs2?.node ||
      (useDefaultOutdir ? "@prisma/client/runtime" : "./runtime"),
    edge:
      runtimeDirs2?.edge ||
      (useDefaultOutdir ? "@prisma/client/runtime" : "./runtime"),
  };
  const finalOutputDir2 = useDefaultOutdir
    ? await getDefaultOutdir(outputDir2)
    : outputDir2;
  if (!useDefaultOutdir) {
    await verifyOutputDirectory(finalOutputDir2, datamodel2, schemaPath2);
  }
  const packageRoot = await (0, import_pkg_up.default)({
    cwd: import_path7.default.dirname(finalOutputDir2),
  });
  const projectRoot2 = packageRoot
    ? import_path7.default.dirname(packageRoot)
    : process.cwd();
  return {
...
async function verifyOutputDirectory(directory, datamodel2, schemaPath2) {
  let content;
  try {
    content = await import_promises2.default.readFile(
      import_path7.default.join(directory, "package.json"),
      "utf8"
    );
  } catch (e) {
    if (e.code === "ENOENT") {
  ...
  if (name === import_package.name) {
    const message = [
      `Generating client into ${bold(directory)} is not allowed.`,
    ];
    message.push(
    ...
    if (
      outputDeclaration &&
      outputDeclaration.content.includes(import_package.name)
    ) {
      const outputLine = outputDeclaration.content;
      message.push(`In ${bold(schemaPath2)} replace:`);
      message.push("");
      message.push(
        `${dim(outputDeclaration.lineNumber)} ${replacePackageName(
          outputLine,
          red(import_package.name)
        )}`
      );
      message.push("with");
      message.push(
      ...
      message.push(
        `Generate client into ${bold(
          replacePackageName(directory, green(".prisma/client"))
        )} instead`
      );
    }
    message.push("");
...
async function copyRuntimeFiles({ from, to, runtimeName, sourceMaps }) {
  ...
  await Promise.all(
    files.map((file) =>
      import_promises2.default.copyFile(
        import_path7.default.join(from, file),
        import_path7.default.join(to, file)
      )
    )
  );
}
async function deleteOutputDir(finalOutputDir2) {
  try {
    ...
    if (
      require(`${finalOutputDir2}/package.json`).name === GENERATED_PACKAGE_NAME
    ) {
      await import_promises2.default
        .rmdir(finalOutputDir2, { recursive: true })
        .catch(() => {
  ...
  generatorHandler({
    onManifest(config) {
      const requiredEngine =
        getClientEngineType(config) === "library" /* Library */
          ? "libqueryEngine"
          : "queryEngine";
    ...
    async onGenerate(options2) {
      ...
      return generateClient({
        ...
        copyRuntimeSourceMaps: Boolean(
          process.env.PRISMA_COPY_RUNTIME_SOURCEMAPS
        ),
        dmmf: options2.dmmf,
